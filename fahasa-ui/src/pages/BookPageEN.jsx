        ...
        <div className="flex-1 px-10 py-10 bg-white">
          <div className="flex items-center gap-x-5">
            <div className="rounded-lg">
              <img
                src="https://cdn0.fahasa.com/media/wysiwyg/NGOAI-VAN-2018/AUG-2018/Bestsellers1920x350-111.jpg"
                alt=""
          ...
          <div className="grid grid-cols-6 gap-5 mt-5">
            <div className="rounded-lg">
              <img
                src="https://cdn0.fahasa.com/media/wysiwyg/Thang-10-2021/logocambridge.jpg"
                alt=""
                className="object-cover w-full h-full rounded-lg"
              />
            </div>
